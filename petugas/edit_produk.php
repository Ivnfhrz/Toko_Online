...
<html>
  ...
  <body>
      ...
      <center>
      <form method="POST" action="ubah_produk.php" enctype="multipart/form-data" >
      <section class="base">
        ...
        <div>
          ...
          <img src="../foto_produk/<?php echo $data['foto_produk']; ?>" style="width: 120px;float: left;margin-bottom:5px; border-radius: 15px;">
