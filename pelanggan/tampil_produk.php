...
<html>
  ...
  <?php
  include('header.php'); //agar index terhubung dengan database, maka koneksi sebagai penghubung harus di include
?>
  <body>
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td style="text-align: center;"><img src="../foto_produk/<?php echo $row['foto_produk']; ?>" style="width: 120px;"></td>
          <td>
